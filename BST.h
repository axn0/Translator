 ...
 * 
 * Author: Anthony Nguyen 301545011
 *         April Nguyen   301314527
...
private:
   ...
   // Description: Recursively copies a binary search tree
   BSTNode* copyTree(BSTNode * current);

   // Description: Recursively deletes a binary search tree
   void clearTree(BSTNode * current);
   ...
   bool insertR(BSTNode * newNode, BSTNode * current);
